...
<body>
    ...
    <div class="container my-5" style="padding-top: 80px;">
        <h3 class="text-center mb-5">Student name:   <big><i>${studentName}</i></big> </h3>
        ...
        <div class="row mb-3">
            ...
            <div class="col">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <c:forEach var="course" items="${unregisteredCourses}">
                            <tr>
                                <td>${course.courseId}</td>
                                <td>${course.courseName}</td>
                                <td>
                                    <form action="RegisterCourseServlet" method="post" onsubmit="return confirm('Are you sure you want to register for this course?')">
                                        <input type="hidden" name="courseIdName" value="${course.courseId}">
